...
const MessageChatSection: React.FC = () => {
  ...
  return (
    <div className="w-7/12 rounded-lg border min-h-screen h-auto shadow-lg">
      <div className="bg-white min-h-screen max-h-max">
        {/* Head */}
        <div className="w-full flex rounded-lg bg-blue-50 h-12 border items-center">
          {/* Display picture and online status */}
          <div className="flex gap-1 justify-center items-center">
            <div className="w-10 h-10 m-2 flex justify-center items-center bg-white border rounded-lg">
              <img
                className="w-7"
        ...
        <div className="h-aut0 pb-0">
          <div className="mb-2">
            <div className="w-full flex justify-center">
              <div className="flex items-center w-10/12 mb-5">
                <input
                  type="text"
