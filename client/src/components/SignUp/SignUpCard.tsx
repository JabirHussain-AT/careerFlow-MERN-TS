...
const SignUpCard: React.FC = () => {
  ...
  const formik = useFormik<SignUpFormValues>({
    ...
    onSubmit: async (values) => {
      ...
      console.log(values, 'this is after submitting');
    },
  });
        ...
        <form className="space-y-4 md:space-y-6" onSubmit={formik.handleSubmit}>
          <div>
            ...
            <input
              ...
              name="userName"
              id="username"
              className={`bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${formik.touched.userName && formik.errors.userName && 'border-red-500'}`}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                id="password"
                placeholder="••••••••"
                className={`bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${formik.touched.password && formik.errors.password && 'border-red-500'}`}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              ...
              >
                {showPassword ? <IoMdEyeOff color="#808080" size={16} /> : <IoMdEye color="#808080" size={16} />}
              </button>
            </div>
          ...
          <div>
            ...
            <input
              ...
              id="confirmPassword"
              placeholder="••••••••"
              className={`bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${formik.touched.confirmPassword && formik.errors.confirmPassword && 'border-red-500'}`}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
